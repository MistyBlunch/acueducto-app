...
const statCardVariants = cva('transition-all duration-300', {
  variants: {
    variant: {
      ...
      gradient:
        'bg-gradient-to-br from-lovable-purple-50 to-lovable-pink-50 border-lovable-purple-100 hover:shadow-lovable',
    ...
    return (
      ...
      >
        ...
        >
          ...
          <div
            className={cn(
              statValueVariants({ size: valueSize, variant: valueVariant }),
            )}
          >
