...
export function ErrorState({
      ...
      switch (error.statusCode) {
        case 0:
          return {
            ...
            message:
              error.error ||
              'No se pudo conectar con la API. Verifica que esté ejecutándose en http://localhost:3001',
        ...
        case 400:
          return {
            ...
            message:
              'Los parámetros de búsqueda no son válidos. Intenta con términos diferentes.',
            color: 'text-warning',
        ...
        case 404:
          return {
            ...
            message:
              error.error ||
              'El servicio de búsqueda no está disponible. Verifica que la API esté ejecutándose.',
            color: 'text-destructive',
            bgColor: 'bg-destructive/10',
            canRetry: true,
          };
        case 429:
          return {
            ...
            message:
              'Has realizado muchas búsquedas. Espera un momento antes de intentar de nuevo.',
            color: 'text-warning',
            bgColor: 'bg-warning/10',
            canRetry: true,
          };
        case 500:
          return {
            ...
            message:
              error.error ||
              'Error interno del servidor. Verifica que la API esté funcionando correctamente.',
            color: 'text-destructive',
            bgColor: 'bg-destructive/10',
            canRetry: true,
          };
  ...
  return (
    <div className="flex flex-col items-center justify-center py-16 text-center">
      <div
        className={`w-20 h-20 ${errorInfo.bgColor} rounded-full flex items-center justify-center mb-6`}
      >
      ...
      <p className="text-muted-foreground max-w-md mb-4">{errorInfo.message}</p>
