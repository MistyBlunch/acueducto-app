...
describe('ProductCard', () => {
  it('should render product information correctly', () => {
    ...
    expect(screen.getByText(/producto profesional de alta calidad/i)).toBeInTheDocument()
  ...
  it('should render product with discount correctly', () => {
    ...
    expect(screen.getByText(/50% de descuento palíndromo aplicado/i)).toBeInTheDocument()
  })
  ...
  it('should show discount message only when palindrome discount is applied', () => {
    ...
    expect(screen.queryByText(/50% de descuento palíndromo aplicado/i)).not.toBeInTheDocument()
  ...
  it('should handle long product titles and descriptions gracefully', () => {
    const longProduct: Product = {
      ...mockProduct,
      title: 'This is a very long product title that should be truncated properly to avoid layout issues',
      description: 'This is an extremely long product description that should be truncated with ellipsis to maintain a clean card layout and prevent the card from becoming too tall or breaking the grid system.',
    }
