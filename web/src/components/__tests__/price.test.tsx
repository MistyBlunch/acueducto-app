...
describe('Price', () => {
  ...
  it('should show palindrome discount message when applied', () => {
    ...
    expect(screen.getByText('¡50% de descuento palíndromo aplicado!')).toBeInTheDocument()
  })
  ...
  it('should not show palindrome discount message for regular discounts', () => {
    ...
    expect(screen.queryByText('¡50% de descuento palíndromo aplicado!')).not.toBeInTheDocument()
  })
